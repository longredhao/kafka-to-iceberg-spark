...
import org.apache.avro.LogicalTypes.{Date, Decimal, TimeMicros, TimestampMicros, TimestampMillis}
...
object SchemaConverters {
  ...
  def toSqlTypeHelper(avroSchema: Schema, existingRecordNames: Set[String]): SchemaType = {
    avroSchema.getType match {
      ...
      case STRING => avroSchema.getLogicalType match {
        case _: TimestampZoned => SchemaType(TimestampType, nullable = false)
        case _ => SchemaType(StringType, nullable = false)
      }
      ...
      case LONG => avroSchema.getLogicalType match {
        ...
        case _: TimeMicros => SchemaType(StringType, nullable = false)
